...
var MatSliderVisualThumb = class {
...
MatSliderVisualThumb.ɵfac = function MatSliderVisualThumb_Factory(t) {
  return new (t || MatSliderVisualThumb)(ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(NgZone), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(MAT_SLIDER));
};
MatSliderVisualThumb.ɵcmp = ɵɵdefineComponent({
...
var MatSlider = class extends _MatSliderMixinBase {
...
MatSlider.ɵfac = function MatSlider_Factory(t) {
  return new (t || MatSlider)(ɵɵdirectiveInject(NgZone), ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(Platform), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(Directionality, 8), ɵɵdirectiveInject(MAT_RIPPLE_GLOBAL_OPTIONS, 8), ɵɵdirectiveInject(ANIMATION_MODULE_TYPE, 8));
};
...
MatSliderThumb.ɵfac = function MatSliderThumb_Factory(t) {
  return new (t || MatSliderThumb)(ɵɵdirectiveInject(NgZone), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(MAT_SLIDER));
};
MatSliderThumb.ɵdir = ɵɵdefineDirective({
  type: MatSliderThumb,
...
var MatSliderRangeThumb = class extends MatSliderThumb {
  /** @docs-private */
  getSibling() {
    if (!this._sibling) {
...
MatSliderRangeThumb.ɵfac = function MatSliderRangeThumb_Factory(t) {
  return new (t || MatSliderRangeThumb)(ɵɵdirectiveInject(NgZone), ɵɵdirectiveInject(MAT_SLIDER), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(ChangeDetectorRef));
};
MatSliderRangeThumb.ɵdir = ɵɵdefineDirective({
